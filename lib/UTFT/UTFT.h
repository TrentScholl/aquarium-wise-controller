...
#define UTFT_VERSION	275
//Affichage déporté (send display informations to COM port to simulate TFT screen with PC - need PC software-)
//#define TERMINAL_X

#ifdef TERMINAL_X
  #define TX_FILLRECT 0xA3
  #define TX_CLRSCR 0xAA 
  #define TX_SETCOLOR 0xA1
  #define TX_SETBACKCOLOR 0xAB
  #define TX_DRAWPIXEL 0xA6
  #define TX_DRAWLINE 0xA7
  #define TX_DRAWHLINE 0xA8
  #define TX_DRAWVLINE 0xA9
  #define TX_PRINTCHAR 0xA2
#endif
////////
...
*/
    ...
    void Lcd_ScrollAreaSetup(int VL1, int VL2);
